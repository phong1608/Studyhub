...
const NewCoursePage = () => {
  ...
  return (
    <div className="overflow-hidden flex w-full" style={{ background: '#edf2f7' }}>
      <section className="max-w-4xl p-6 mx-auto rounded-md dark:bg-gray-800 mt-20 w-full overflow-auto" onSubmit={hanldeSubmit}>
        ...
        <form>
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mt-16">
            <div>
                <label className="text-black dark:text-gray-200">Tên khóa học </label>
            ...
            <div>
              <label className="text-black dark:text-gray-200">Thứ tự </label>
              <input 
                id="position" 
                type="number" 
            ...
            {option === 'Text' && (
              ...
              <JoditEditor ref={editor} value={description} onChange={e=>setContent(e)} />
              </div>
            )}
            {option === 'Video' && (
              <div>
